...
from toolbox import PLV, PLE, epochingTool, multitapper
...
def simulate_parallel(params):
    ...
    for set in params:
        ...
        _, _, IAF, module, band_module = multitapper(data, samplingFreq, peaks=True)
        ...
        for b in range(len(bands[0])):
            ...
            ## Gather results
            result.append((emp_subj, mode, g, s, r, IAF[0], module[0], band_module[0], bands[0][b], plv_r))
