...
integrator = integrators.HeunStochastic(dt=1000/samplingFreq, noise=noise.Additive(nsig=np.array([1e-2])))
...
coupling_vals = [0.25,0.3,0.35,0.4,0.45,0.5,0.55]#np.arange(0.15,2,0.1)
speed_vals = [3,6]#np.arange(0.5,18,3)
