...
specific_folder = main_folder+"\\""scPSE"+subjectid+"-"+emp_subj+"-"+time.strftime("m%md%dy%Y-t%Hh.%Mm.%Ss")
...
## GATHER RESULTS
simname = "empsc-simfc" + subjectid+"-"+emp_subj+"-t"+str(simLength)+"-"+time.strftime("m%md%dy%Y")
...
paramSpace(dfPLV_m, 0.5, "empsc-simfc"+emp_subj+subjectid+"_PLV", folder=specific_folder)
paramSpace(dfPLV_sd, 0.5, "empsc-simfc"+emp_subj+subjectid+"_PLV_sd", folder=specific_folder)
