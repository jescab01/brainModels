...
m = models.ZetterbergJansen(He=np.array([3.25]), Hi=np.array([22]),
                            ...
                            gamma_1=np.array([135]), gamma_1T=np.array([0]), gamma_2=np.array([108]),
                            gamma_2T=np.array([1]),
                            gamma_3=np.array([33.75]), gamma_3T=np.array([0]), gamma_4=np.array([33.75]),
                            gamma_5=np.array([0]),
