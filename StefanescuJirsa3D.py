...
m = models.ReducedSetHindmarshRose(K11=np.array([0.5]), K12=np.array([0.1]), K21=np.array([0.15]),
                                   a=np.array([1]), b=np.array([3]), c=np.array([1]), d=np.array([5]),
                                   mu=np.array([3.3]), r=np.array([0.006]), s=np.array([4]), sigma=np.array([0.3]),
                                   xo=np.array([-1.6]))
