...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\jesca\\PycharmProjects\\brainModels\\psychopy\\trial_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('Sentences4Verification.xlsx', selection='1:10'),
