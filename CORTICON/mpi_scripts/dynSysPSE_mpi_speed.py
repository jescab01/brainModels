...
spaces = "bigNet_plv_speed"  # "singles", "coupled", "c_sigma"
name = "dynSys_" + spaces
...
coupling_vals = np.arange(0, 200, 2)
speed_vals = np.arange(0.5, 20, 3)

# w_vals = np.arange(0, 1, 0.05)
p_vals = np.arange(0, 0.5, 0.05)
