...
p_vals = np.arange(0, 0.22, 0.005)
taue_vals = np.arange(4, 40, 6)
taui_vals = np.arange(2, 40, 6)

params = [[p, taue, taui] for p in p_vals for taue in taue_vals for taui in taui_vals]
...
local_results = surf_parallel(local_params)  # run the function for each parameter set and rank
